...
public class TransactionRecord {
    ...
    public TransactionRecord(int step, String type, Double amount, String nameOrig, Double oldbalanceOrg, Double newbalanceOrig, String nameDest, Double oldbalanceDest, Double newbalanceDest, int isFraud, int isFlaggedFraud) {
        this.step = step;
        this.type = type;
        this.amount = amount;
    ...
    public String toString() {
        return "Type: " + type + ", Amount: " + amount + ", Fraud: " + isFraud;
    }
